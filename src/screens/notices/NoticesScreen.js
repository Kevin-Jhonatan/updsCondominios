...
const DATA = [
  ...
  },
  {
    ...
    title: 'Comunicado 6',
    description:
      'Vestibulum eu sollicitudin ligula, eget tempor mi. Nullam at facilisis dui. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Praesent tincidunt convallis dolor sit amet laoreet. Aliquam mattis ullamcorper quam eget consequat. Morbi nec justo neque. Praesent quis lectus massa. Fusce sit amet viverra justo, quis porta tellus.',
    date: '15-02-2022',
  },
  {
    id: 7,
        ...
        {DATA.length > 0 ? (
          <FlatList
            ...
            renderItem={({item}) => (
              <NoticesListItem
                item={item}
                navigation={navigation}></NoticesListItem>
            )}
          />
        ) : (
          <View>
